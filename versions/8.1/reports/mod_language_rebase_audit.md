...
- 검토 키 중 현재 산출물에 없는 키: 995개
- 현재 영어 원문 전체에서 산출물에 없는 키: 3,118개
- 검토 키 중 영어 원문과 같은 산출물: 13개
- 현재 키 구조와 보호 문자열 검사가 끝난 영향 네임스페이스: 19개
- 그대로 재사용 가능한 키: 35,554개
- 현재 원문에서 제거된 키: 255개
- 자리표시자·서식 오류: 72개
...
| ftbquests | 135 | 135 | 135 | 0 | 0 | 135 | 23 | 아니요 |
...
| computercraft | 0 | 3 | 0 | 0 | 0 | 0 | 0 | 아니요 |
...
- 현재 JAR 중복 원문 충돌 기록: 28개
- 기준 JAR 중복 원문 충돌 기록: 28개
- 중복 키는 파일명 정렬상 뒤의 JAR 값을 사용합니다. 현재 설치본의 CC:Tweaked는 실행 로그에서 1.120.2가 로드된 것을 확인했습니다.
