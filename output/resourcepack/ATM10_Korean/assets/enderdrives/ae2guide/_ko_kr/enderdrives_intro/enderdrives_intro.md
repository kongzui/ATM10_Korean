...
엔더 드라이브는 주파수가 같으면 서로 다른 ME 네트워크와 차원, 플레이어 사이에서도 같은 저장소를 공유하는 저장 셀입니다.
...
제 환경의 평균은 약 275,000종입니다. 275,000/255 ≈ 1078이며, 이 계산은 256k 엔더 아이템 저장 셀의 개수입니다. ME 드라이브로는 107.8개를 서로 다른 종류의 아이템으로 채워야 성능 문제가 나타나기 시작합니다. 권장 최대 종류 수는 이보다 높거나 낮을 수 있습니다. 이 한도는 같은 월드에서 드라이브를 이용하는 모든 사용자가 공유합니다.
