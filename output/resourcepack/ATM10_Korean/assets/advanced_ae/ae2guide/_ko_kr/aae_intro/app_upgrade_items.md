...
패턴과 업그레이드를 모두 옮기지 않고도 패턴 제공기를 업그레이드할 수 있게 해 주는 Advanced AE
제공기 아이템입니다.
...
일반 AE 패턴 제공기와 Extended AE의 확장 패턴 제공기에 사용할 수 있습니다. 이 업그레이드를 사용하면
기존 슬롯 수를 그대로 유지한 고급 버전으로 바뀝니다. 따라서 일반 제공기를 확장 제공기로
...
용량 업그레이드는 일반 패턴 제공기를 패턴 슬롯 36개를 가진 고급 패턴 제공기로 바로
업그레이드합니다.
