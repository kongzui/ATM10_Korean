...
전기 용광로는 전기로 작동하는 용광로입니다. 새로운 제작법들을 활용할 수 있고, 다른 전기 멀티블록 기계들처럼 최대 128EU/t 만큼의 오버클럭을 지원합니다.
...
전기 용광로는 전기를 받아들일 에너지 입력 해치가 없다면 작동하지 않습니다. LV 에너지 입력 해치는 LV 전선에만 연결됩니다.

<Recipe id="modern_industrialization:hatches/basic/energy_input_hatch" />

MV 에너지 입력 해치는 MV 전선에만 연결됩니다. 만약 전기 용광로에 많은 에너지를 공급하고 싶다면, MV 해치 사용을 추천드립니다. 아직 만들 수는 없지만요...
