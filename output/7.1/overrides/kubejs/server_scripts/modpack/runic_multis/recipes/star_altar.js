ServerEvents.recipes(allthemods => {
    //Awakened Alloy Block
        allthemods.recipes.modern_industrialization.star_altar(2048, 200)
            ...
            .itemOut(`allthemodium:unobtainium_vibranium_alloy_block[enchantments={levels:{"minecraft:unbreaking":1}},custom_name='{"extra":[{"italic":false,"text":"각성한 Unobtainium-Vibranium 합금 블록"}],"text":""}']`)
    ...
    //ATM Star
        allthemods.recipes.modern_industrialization.star_altar(2048, 200)
            ...
            .itemIn(`2x allthemodium:unobtainium_vibranium_alloy_block[enchantments={levels:{"minecraft:unbreaking":1}},custom_name='{"extra":[{"italic":false,"text":"각성한 Unobtainium-Vibranium 합금 블록"}],"text":""}']`)
