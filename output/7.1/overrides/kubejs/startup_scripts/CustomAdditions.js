...
StartupEvents.registry('item', allthemods => {
    ...
    allthemods.create('atm_star_shard_3').displayName('ATM의 별 조각')
    allthemods.create('atm_star_shard_4').displayName('ATM의 별 조각')
    allthemods.create('atm_star_shard_5').displayName('ATM의 별 조각')
    ...
    allthemods.create("allthemodium_solar_sail_package").displayName("Allthemodium 태양 돛 패키지").component("dysoncubeproject:sphere_component_solar_sail", Java.cast("java.lang.Integer", 64))
    allthemods.create("allthemodium_beam_package").displayName("Allthemodium 빔 패키지").component("dysoncubeproject:sphere_component_beam", Java.cast("java.lang.Integer", 16))
