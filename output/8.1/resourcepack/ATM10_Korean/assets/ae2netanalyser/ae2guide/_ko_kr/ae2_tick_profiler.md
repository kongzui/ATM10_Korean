...
숫자는 이 블록의 틱 처리 시간을 나타냅니다. TPS(초당 틱 수)가 20보다 낮으면 게임이 느려집니다.
즉, 게임 전체의 틱 처리 시간은 항상 50,000 μs/틱보다 짧아야 합니다.

일반적으로 대부분의 블록은 틱 처리 시간이 100 μs/틱보다 짧아야 하며, 이를 넘으면 렉의 원인이 될 수 있습니다.
