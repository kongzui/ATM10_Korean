...
ME 고급 패턴 공급기는 일반 <ItemLink id="ae2:pattern_provider" /> 또는
<ItemLink id="extendedae:ex_pattern_provider" />를 업그레이드하여, 패턴의 각 아이템을 밀어 넣을 면을
...
패턴 공급기 하나에 최대 36개의 패턴을 담을 수 있는 고급 확장 패턴 공급기도 있습니다.

![ME 고급 패턴 공급기 GUI](../pic/app_gui.png)
