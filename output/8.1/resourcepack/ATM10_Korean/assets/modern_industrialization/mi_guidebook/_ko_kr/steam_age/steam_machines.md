...
화로는... 그냥 화로입니다. 일반 화로와 속도가 비슷하지만, 증기가 매우 효율적이기 때문에 연료를 10배 더 효율적으로 사용합니다.
...
모든 기계들은 출력면이 있습니다. 인터페이스에서 자동 출력을 활성화하면 해당 면에 인접한 상자 등에 아이템이 출력됩니다. 깔대기, 파이프 등 또한 아무 면으로나 아이템을 뽑아갈 수 있습니다. 슬롯에서 휠을 사용해 한 슬롯에 있을 수 있는 최대 아이템 개수를 조정할 수 있습니다.

렌치를 기계에 우클릭해서 기계를 돌릴 수 있습니다. 웅크린 채로 우클릭하면 출력면을 설정할 수 있습니다.
