...
페인트볼은 <ItemLink id="color_applicator" />에서 [케이블](cables.md), 양털, 테라코타, 유리, 콘크리트처럼
색을 입힐 수 있는 블록을 칠하는 데 사용됩니다. <ItemLink id="matter_cannon" />에 넣어 작은 페인트 자국을 쏠 수도 있습니다.

## 조합법

염료 주위에 물질 덩어리 8개를 놓습니다.
...
일반 페인트볼과 똑같이 작동하지만 <ItemLink id="matter_cannon" />으로 쏜 자국에서 빛이 납니다.
조명탄 발사기처럼 쓸 만합니다.

## 조합법

발광석 가루 주위에 페인트볼 8개를 놓습니다.
