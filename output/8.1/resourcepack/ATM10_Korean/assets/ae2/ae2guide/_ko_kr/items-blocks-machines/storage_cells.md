...
바이트와 종류에 따른 용량 설명은 [바이트와 종류](../ae2-mechanics/bytes-and-types.md)를 참고하세요.
...
[종류의 선불 비용](../ae2-mechanics/bytes-and-types.md) 때문에 한 종류만 저장하는 셀은 63종류를 모두 사용하는 셀보다 2배 많이 저장할 수 있습니다.

| 셀                                       | 1종류 사용 시 셀의 총용량 | 63종류 사용 시 셀의 총용량 |
| ---------------------------------------- | ----------------------------------------: | ------------------------------------------: |
...
아이템 저장 셀은 서로 다른 아이템 종류를 최대 63개까지 저장하며, 모든 표준 용량으로 제공됩니다.
...
표준 저장 셀과 달리 바이트 용량이 늘어날수록 종류 용량이 *줄어들며*, 총 바이트 용량은 절반입니다.
...
유체 저장 셀은 서로 다른 유체 종류를 최대 5개까지 저장하며, 모든 표준 용량으로 제공됩니다.
