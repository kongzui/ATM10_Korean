...
TRANSLATIONS: dict[str, dict[str, object]] = {
    ...
    "related": {
        ...
        "quest.42AF4EBDA5D6CC36.quest_desc": [
            "가장 강한 금속 세 가지인 &5텅스텐&r, &d티타늄&r과 &7스테인리스강&r을 조합하면 &2방폭 합금&r을 만들 수 있습니다. 얼룩도 중요했나 보네요. \n\n이 재료를 조합하여 &2케이싱&r을 만드세요. \n\n&3&l불가능 확률 장치&r에는 &2방폭 케이싱&r 2개 또는 256M 휴대용 아이템 셀 2개가 필요하며, 두 재료를 섞어 써도 됩니다!"
        ],
        "quest.42AF4EBDA5D6CC36.title": "&2방폭 케이싱",
