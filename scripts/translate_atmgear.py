...
EXPLICIT = {
    ...
    "block.allthemodium.allthemodium_source_jar": "Allthemodium 원천 단지",
}
...
ARCANIST = {
    ...
    "allthearcanistgear.perk_desc.thread_vitality": "레벨마다 하트 1개를 추가합니다.",
