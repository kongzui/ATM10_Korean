...
KEY_OVERRIDES.update(
    {
        "quest.0B35172E47705205.quest_subtitle": "광석 처리: 1단계",
        "quest.0EC2053B191C55C6.quest_desc": [
            "원목에서 라텍스를 추출하며, 전력을 공급하면 더 빨리 작동합니다."
            "\\n\\n사용 가능한 원목과 라텍스 생산량은 JEI에서 확인하세요. "
            "아카시아와 맹그로브 원목의 생산량이 가장 많습니다."
        ],
        "quest.1684D52FDAAC894B.quest_subtitle": "광석 처리: 2단계",
        "quest.1F66CDC9799B5DEC.quest_desc": [
            "대부분의 렌치로 &bIndustrial Foregoing&r 기계를 돌릴 수 없어, "
            "&bIF&r 기계를 회전시키는 렌치를 정리했습니다. 주로 레이저 드릴에서 "
            "시험했으므로 다른 기계에서는 작동하지 않는 렌치가 있을 수 있습니다."
            "\\n\\n사용 가능한 모든 렌치는 이 퀘스트의 Task를 눌러 확인하세요."
        ],
        "quest.287B47E27EBC2C18.quest_desc": [
            "마법 부여 공장은 자동 마법 부여대입니다. 장비나 책과 &a정수&r를 "
            "공급하면 무작위 마법을 부여합니다. 바로 위 탱크의 유체도 사용할 수 "
            "있어 장비와 책에 더 강한 마법을 부여할 수 있습니다."
        ],
        "quest.2E8E292ED596A104.quest_desc": [
            "레이저 렌즈는 광석 레이저 베이스가 특정 색상 광석을 생산할 확률을 "
            "높입니다. 광석별로 가장 알맞은 렌즈는 JEI에서 확인하세요. 렌즈는 유체 "
            "레이저 베이스가 생산할 수 있는 유체 종류도 결정합니다."
        ],
        "quest.33532408B21A5378.quest_desc": [
            "조악한 발전기는 석탄 같은 가연성 연료로 소량의 FE를 생산합니다."
        ],
        "quest.339DF320DDCAD98B.title": "아이템 및 유체 전송",
        "quest.34AA079FFAFC64BD.quest_subtitle": "광석 처리: 3단계",
        ...
        "quest.690CFF61CE787D43.quest_desc": [
            "플라스틱은 &bIndustrial Foregoing&r의 주요 자원입니다. 이제 여러 "
            "유용한 기계를 제작할 수 있습니다!"
        ],
        "quest.6E131A32A96D7BF5.quest_desc": [
            "슬러지 정제기는 &#5919B6슬러지&r로 흙, 자갈, 영혼 모래 같은 자원을 "
            "생산합니다. 전체 생산물은 JEI에서 확인하세요."
        ],
        "quest.4B12425E74C5E511.quest_desc": [
            "&c폭발 균사 발전기&r는 폭발을 흡수하는 성능이 뛰어납니다."
            "\\n\\n이 특성을 &d&l맥동하는 &8블랙홀&r에 활용할 수 있습니다!"
        ],
        "task.1F1A69738DE70DB6.title": "균사 반응기",
        "quest.47043AF7D1FABC43.quest_desc": [
            "아이템의 마법 부여를 책으로 옮기는 방법은 다양합니다. 이 퀘스트에서는 "
            "그중 여러 방법을 소개합니다.\\n\\n&cSuper Factory Manager&r: 제가 "
            "떠올릴 수 있는 가장 저렴한 방법 중 하나로 &a경험치&r가 전혀 들지 "
            "않습니다. &5흑요석&r 블록 위에 마법이 부여된 아이템과 책 여러 권을 "
            "떨어뜨린 뒤, 떨어지는 &8모루&r가 그 위에 착지하게 하세요.\\n\\n"
            "&b마법 해제대&r: 마법이 부여된 아이템을 왼쪽 칸에, 책을 가운데 칸에 "
            "넣으면 마법 부여가 책 형태로 오른쪽 칸에 나옵니다! &a경험치&r가 "
            "필요합니다.\\n아이템 대신 마법이 부여된 책을 넣어 여러 마법 부여를 "
            "나눌 수도 있습니다.\\n\\n&6Draconic Evolution 마법 추출기&r: 마법이 "
            "부여된 아이템에서 원하는 마법 하나를 골라 책으로 옮길 수 있습니다. "
            "&a경험치&r가 필요합니다.",
            "{@pagebreak}",
            "&cEvilCraft 정화기와 Blook&r: &c피&r를 사용해 마법이 부여된 아이템의 "
            "마법을 &cBlook&r으로 옮깁니다.\\n\\n&5&lApothic Enchanting 고서&r: "
            "모루에서 사용하면 마법이 부여된 아이템의 마법을 추출합니다.\\n"
            "&8Scrapping 고서&r는 마법 부여 절반만 추출하고 아이템을 파괴합니다."
            "\\n&8Superior Scrapping 고서&r는 모든 마법 부여를 추출하고 아이템을 "
            "파괴합니다.\\n&8Extraction 고서&r는 모든 마법 부여를 추출하면서 "
            "아이템을 보존합니다.\\n이 고서에 마법을 주입하는 방법은 &5&lApothic "
            "Enchanting&r 챕터에서 확인하세요.\\n\\n&bIndustrial Foregoing 마법 "
            "부여 추출기&r: 자동 마법 해제에 추천합니다. 기계에 마법이 부여된 "
            "아이템과 책을 넣으면 아이템의 마법을 추출합니다. 원한다면 마법을 "
            "&a정수&r로 바꿀 수도 있습니다.\\n\\n&8Corail Tombstone 마법 해제의 "
            "책&r: 장식 무덤에는 때때로 무덤 영혼이 떠돕니다. 보조 손에 책을, "
            "주손에 마법이 부여된 아이템을 들고 무덤 영혼을 우클릭하면 마법을 "
            "제거해 책으로 돌려받을 수 있습니다. 무덤이 조금 부패하니 주의하세요."
            "\\n\\n&5Actually Additions 마법 해제 렌즈&r: 원자 재구성기에 장착하는 "
            "렌즈입니다. 재구성기가 내보내는 레이저 앞에 마법이 부여된 아이템과 "
            "책 한 권을 던지면 마법 하나를 아이템에서 책으로 분리합니다.",
        ],
    }
)
