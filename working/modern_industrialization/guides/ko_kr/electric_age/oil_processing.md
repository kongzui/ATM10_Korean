...
멀티블록의 구조는 다음과 같습니다: 강철 기계 케이싱, 강철 파이프 기계 케이싱, 그리고 사슬입니다. 다른 멀티블록들처럼, 렌치를 든 상태에서 컨트롤러를 바라보면 각 블록의 위치를 알 수 있습니다. 해치는 강철 기계 케이싱 자리에만 놓을 수 있으며, 최소한 아이템 입력 해치, 유체 출력 해치, 에너지 입력 해치 하나씩은 있어야 합니다.

원유는 여러 연료들, 그리고 더 효율적인 고무 제작에 활용될 수 있습니다.
